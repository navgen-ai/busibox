...
main() {
    ...
    echo -e "     ${CYAN}ansible-vault view roles/secrets/vars/vault.yml${NC}"
    echo ""
    ...
    echo -e "     ${DIM}(backup saved at: provision/ansible/roles/secrets/vars/backups/env.local.backup.${TIMESTAMP})${NC}"
    echo ""
