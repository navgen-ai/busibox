...
# ==========================
#
# Generates a fresh admin magic link token and opens it in the browser.
...
main() {
    ...
    info "Generating admin magic link for ${email_lower} (${env}/${backend})..."
    ...
    success "Admin magic link generated."
    echo ""
