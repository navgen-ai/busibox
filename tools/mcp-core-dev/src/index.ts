...
const CORE_DEV_TOOLS = [
  ...
  { name: 'run_docker_tests', description: 'Run Docker tests (returns command)', inputSchema: { type: 'object', properties: { service: { type: 'string', enum: ['authz', 'ingest', 'search', 'agent', 'all'] }, fast: { type: 'boolean' }, pytest_args: { type: 'string' } }, required: ['service'] } },
  { name: 'run_remote_tests', description: 'Run remote tests (returns command)', inputSchema: { type: 'object', properties: { service: { type: 'string', enum: ['authz', 'ingest', 'search', 'agent', 'all'] }, environment: { type: 'string', enum: ['staging', 'production'] }, fast: { type: 'boolean' }, worker: { type: 'boolean' }, pytest_args: { type: 'string' } }, required: ['service', 'environment'] } },
  { name: 'run_container_tests', description: 'Run tests on containers via SSH', inputSchema: { type: 'object', properties: { service: { type: 'string', enum: ['authz', 'ingest', 'search', 'agent', 'all'] }, environment: { type: 'string', enum: ['staging', 'production'] }, pytest_args: { type: 'string' } }, required: ['service', 'environment'] } },
