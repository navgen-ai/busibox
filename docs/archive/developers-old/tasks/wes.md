...
category: "developer"
order: 101
description: "Personal task tracking and active development items"
published: false
---
...
Substack post topics:

80%->100% concept: as frontier models progress, they get better at handling larger and larger tasks. They also get better at doing those tasks well enough that they don't need human oversight. So what happens then? My conjecture is that the economic value of the task drops to 0 and we stop needing the task, because now it can be entirely done within AI. Expand with examples: web pages - AI can create web pages easily now. But who reads web pages? AI. 

QUID-PRO code - my approach to coding robust systems with AI
question unpack investigate document plan refactor observe
