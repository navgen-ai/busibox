...
```bash
bash scripts/update-bedrock-credentials.sh test
```
...
4. **`docs/configuration/bedrock-setup.md`** - Complete documentation
...
3. Deploy: `cd provision/ansible && make test-litellm`
4. Test: `bash scripts/test-bedrock-setup.sh test`

## ❓ Need Help?

- **Full docs:** `docs/configuration/bedrock-setup.md`
