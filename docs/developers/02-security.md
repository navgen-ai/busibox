...
**Staging Environment** (10.96.201.x):
```python
...
cd provision/ansible
make all INV=inventory/staging
```
...
- [OAuth2 Token Exchange](services/authz/oauth2-token-exchange-implementation.md) - Authentication architecture
- [Bootstrap Test Credentials](services/authz/bootstrap-test-credentials.md) - Setting up test auth
- [Agent Server Testing](services/agents/agent-server-testing.md) - Agent API testing
- [Architecture Overview](architecture/00-overview.md) - System overview
