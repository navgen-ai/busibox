...
| `AUTHZ_BOOTSTRAP_ALLOWED_AUDIENCES` | `data-api,search-api,agent-api,authz-api` | Allowed audiences for bootstrap client |
...
| `data-api` | Data service operations | `authz.keystore.*` |
