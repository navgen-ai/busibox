---
title: "ZFS Storage Recommendations"
category: "developer"
order: 120
description: "Quick reference for ZFS storage configuration in Busibox"
published: true
---
...
### Create All Datasets
```bash
bash provision/pct/host/setup-zfs-storage.sh
```
...
**See Also:**
- [zfs-storage-strategy](../services/data/zfs-storage-strategy.md) - Full implementation guide
- [setup-zfs-storage.sh](../../provision/pct/host/setup-zfs-storage.sh) - Automated setup script
