---
title: "AI Portal Environment Variables"
category: "developer"
order: 139
description: "Complete reference for AI Portal environment variables"
published: true
---
...
> **Note**: As of 2026-01-15, Busibox uses a Zero Trust architecture where AuthZ issues all session JWTs directly. The `busibox-session` cookie contains the session JWT. See [03-authentication](../architecture/03-authentication.md) for details.
...
- Staging: `inventory/staging/group_vars/all/00-main.yml`
...
- **Configuration:** [03-configure](../../administrators/03-configure.md)
- **Application Management:** [04-apps](../../administrators/04-apps.md)
- **Troubleshooting:** [08-troubleshooting](../../administrators/08-troubleshooting.md)
