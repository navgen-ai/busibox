---
title: Core App Rebuild via Management Menu
created: 2026-02-01
updated: 2026-02-01
status: active
category: guides
tags: [make, management, deployment, ai-portal, agent-manager, core-apps]
---
...
- `docs/deployment/ai-portal.md` - Full AI Portal deployment guide
- `docs/deployment/agent-manager.md` - Full Agent Manager deployment guide
