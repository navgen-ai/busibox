...
# Scope dependencies
require_data_read = ScopeChecker("ingest.read")  # Reuse ingest scopes for now
require_data_write = ScopeChecker("ingest.write")
...
class InsertRecordsRequest(BaseModel):
    ...
    validate: bool = Field(default=True, description="Whether to validate against schema")
