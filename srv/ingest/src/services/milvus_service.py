...
Handles insertion of dense, sparse (BM25 auto-generated), and multi-vector (ColPali) embeddings.
"""
    ...
    def insert_text_chunks(
        ...
        for i, (chunk, embedding) in enumerate(zip(chunks, embeddings)):
            ...
            entity = {
                ...
                "modality": "text",
                "text": chunk["text"],  # BM25 auto-generates text_sparse from this
                "text_dense": embedding,
                "text_sparse": None,  # Auto-generated by Milvus
                "page_vectors": None,
                "user_id": user_id,
                "metadata": {
