...
- This allows the ingest-worker to bootstrap itself without manual Milvus setup
"""
...
class MilvusService:
    ...
    def _create_collection(self) -> Collection:
        ...
        when the collection doesn't exist, allowing the ingest-worker to
    ...
    def connect(self, timeout: Optional[float] = None):
        ...
        This allows the ingest-worker to bootstrap itself without manual
