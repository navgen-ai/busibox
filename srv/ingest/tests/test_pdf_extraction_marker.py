"""
Marker PDF Extraction Test - No Database Dependencies

Tests Marker-based PDF extraction on all 10 test documents without requiring
...
def test_pdf_extraction_marker():
    """Test Marker-based PDF extraction on all documents."""
    ...
    # Create config - explicitly enable Marker
    config = {
        "temp_dir": "/tmp/ingest",
        "chunk_size_min": 400,
        "chunk_size_max": 800,
        "chunk_overlap_pct": 0.12,
        "marker_enabled": True,  # Force Marker strategy
    }
