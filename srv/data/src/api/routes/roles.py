...
@router.get("/{file_id}/roles", response_model=DocumentRolesResponse, dependencies=[Depends(require_data_read)])
...
@router.put("/{file_id}/roles", dependencies=[Depends(require_data_write)])
...
@router.post("/{file_id}/share", dependencies=[Depends(require_data_write)])
