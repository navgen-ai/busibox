...
class CreateDataDocumentRequest(BaseModel):
    ...
    visibility: str = Field(default="personal", description="Visibility: personal, shared, or authenticated")
    roleIds: Optional[List[str]] = Field(None, description="Role IDs for shared documents (optional for authenticated)")
