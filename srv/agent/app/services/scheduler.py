...
from app.services.task_notifications import (
    extract_content_from_output as _extract_content_from_output,
    send_task_notification as _shared_send_task_notification,
)
...
class TaskSchedulerService:
    ...
    async def _send_task_notification(
        ...
        """Delegate to shared notification logic."""
        await _shared_send_task_notification(
            session=session,
            task=task,
            execution=execution,
            success=success,
