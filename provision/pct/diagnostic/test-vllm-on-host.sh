...
log_info ""
log_info "3. Or test with the registry-mapped tiny dispatch model (recommended for testing):"
log_info "   python -c 'from vllm import LLM; llm = LLM(\"Qwen/Qwen3.5-0.8B\"); print(llm.generate(\"What is AI?\"))'"
log_info ""
