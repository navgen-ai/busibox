...
def create_collection(collection_name):
    ...
    if utility.has_collection(collection_name):
        ...
        required_fields = ["id", "file_id", "text", "text_dense", "modality"]
    ...
    fields = [
        ...
        # Note: SPARSE_FLOAT_VECTOR not available in pymilvus 2.3.5
        # Sparse BM25 will be added when upgrading to Milvus 2.4+ / pymilvus 2.4+
        # For now, using dense vectors only
